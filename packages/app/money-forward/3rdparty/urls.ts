// https://github.com/hiroppy/mf-dashboard/blob/3e5ad1277055c87a76d7e69efe2fd7bd61b9165b/packages/meta/src/urls.ts
...
export const mfUrls = {
    ...
    csv(date: string, month: number, year: number): string {
        return `${BASE_URL}/cf/csv?from=${encodeURIComponent(date)}&month=${encodeURIComponent(month)}&year=${encodeURIComponent(year)}`
    },
